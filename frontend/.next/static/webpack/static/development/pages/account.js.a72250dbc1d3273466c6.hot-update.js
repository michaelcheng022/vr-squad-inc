...
})(["max-width:500px;min-width:300px;margin:2rem auto;box-shadow:", ";display:flex;font-family:Arial;justify-content:center;.account-container{margin:50px 40px;}.picture-container{display:flex;border:1px solid black;}.btn{display:inline-block;font-weight:400;text-align:center;white-space:nowrap;vertical-align:middle;margin:0 10px;border:1px solid transparent;padding:.125rem .5rem;font-size:1rem;line-height:1.5;border-radius:.25rem;transition:color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out;}.btn-edit{background-color:#ffc107;border-color:#ffc107;float:right;}"], function (props) {
...
//# sourceMappingURL=account.js.a72250dbc1d3273466c6.hot-update.js.map