...
})(["display:grid;grid-template-columns:1fr 1fr 1fr;grid-gap:60px;max-width:", ";margin:0 auto;@media (max-width:1300px){grid-template-columns:1fr 1fr;margin:0 10vw;}@media (max-width:1000px){grid-template-columns:1fr;margin:0 200px;}@media (max-width:700px){margin:0 5vw;}"], function (props) {
...
//# sourceMappingURL=listings.js.72da8629d9acf6e6aa48.hot-update.js.map