...
})(["display:grid;grid-template-columns:1fr 1fr 1fr;grid-gap:60px;justify-content:center;max-width:", ";margin:0 auto;@media (max-width:1300px){grid-template-columns:1fr 1fr;margin:0 10vw;}@media (max-width:1000px){grid-template-columns:1fr;margin:0 100px;}@media (max-width:700px){margin:0 5vw;}"], function (props) {
...
//# sourceMappingURL=listings.js.68e1c1e8cfde6b65f5ea.hot-update.js.map