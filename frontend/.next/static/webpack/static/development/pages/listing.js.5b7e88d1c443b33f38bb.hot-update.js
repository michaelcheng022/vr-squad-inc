...
})(["max-width:1200px;margin:2rem auto;box-shadow:", ";display:grid;font-family:Arial;grid-auto-columns:1fr;grid-auto-flow:column;img{width:100%;height:100%;margin-bottom:20px;object-fit:contain;}.button-container{float:right;}.btn-edit{background:danger;}.details{margin:3rem;font-size:14px;}.section{margin-bottom:20px;}.section h3{width:100%;text-align:left;text-indent:40px;border-bottom:1.5px solid #000;line-height:0.1em;margin:10px 0 20px;}.section h3 span{background:#fff;padding:0 10px;}"], function (props) {
...
//# sourceMappingURL=listing.js.5b7e88d1c443b33f38bb.hot-update.js.map